...
# Folder path and CSV for PRE-MONSOON
folder_path = r"C:\Users\ocean\OneDrive\Desktop\OA Thesis\Standarized Data\Premonsoon\daily\Dailystandarized"
...
print("=" * 70)
print("PRE-MONSOON: Data loaded successfully!")
...
print("\n=== Table: Unrotated Eigenvalues & Variance (Pre-monsoon) ===")
...
print(
    "\n=== Table: Varimax Rotated Factor Loadings & Variance (Pre-monsoon) ==="
)
print(table_final)

# Save CSVs
table_unrotated.to_csv(
    os.path.join(folder_path, "PCA_Unrotated_Variance_Premonsoon.csv"),
    index=False,
)
table_final.to_csv(
    os.path.join(folder_path, "PCA_Varimax_Rotated_Loadings_Premonsoon.csv")
)
print("\n[OK] Pre-monsoon CSV files saved successfully!")