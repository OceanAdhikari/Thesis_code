...
# Folder path and CSV for POST-MONSOON
...
print("=" * 70)
print("POST-MONSOON: Data loaded successfully!")
...
print("\n=== Table: Unrotated Eigenvalues & Variance (Post-monsoon) ===")
...
print(
    "\n=== Table: Varimax Rotated Factor Loadings & Variance (Post-monsoon) ==="
)
print(table_final)

# Save CSVs
table_unrotated.to_csv(
    os.path.join(folder_path, "PCA_Unrotated_Variance_Postmonsoon.csv"),
    index=False,
)
table_final.to_csv(
    os.path.join(folder_path, "PCA_Varimax_Rotated_Loadings_Postmonsoon.csv")
)
print("\n[OK] Post-monsoon CSV files saved successfully!")