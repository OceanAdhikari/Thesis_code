...
# Folder path and confirmed CSV name for WINTER
...
print("\n=== Table 3: Eigenvalues of the correlation matrix (Winter season) ===")
print(table3)
...
print("\n=== Table 4: Varimax Rotated Factor Loadings (Winter season) ===")
print(loadings_df)
# ──────────────────────────────────────────────────────────────────────────

# Save as CSV files
table3_path = os.path.join(folder_path, 'PCA_Table3_Winter.csv')
table3.to_csv(table3_path, index=False)
print(f"\nTable 3 saved to: {table3_path}")

table4_path = os.path.join(folder_path, 'PCA_Table4_Varimax_Winter.csv')
