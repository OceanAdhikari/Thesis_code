...
output_dir = r"C:\Users\ocean\OneDrive\Desktop\OA Thesis\Standarized Data\Monsoon\RF\min2_cancel"
os.makedirs(output_dir, exist_ok=True)

file_path = r"C:\Users\ocean\OneDrive\Desktop\OA Thesis\Standarized Data\Monsoon\RF\Book1.csv"
...
# Test  = 2023
# Quick scan: Train R2=0.814, Test R2=0.683, Gap=0.131
# Mean PM2.5 difference = 0.50 ug/m3 (almost identical)
# ─────────────────────────────────────────────────────────────
test_year   = 2023
...
print("\n" + "="*70)
print("MONSOON SEASON - RANDOM FOREST MODEL FOR PM2.5 PREDICTION")
print("(Same methodology as pre-monsoon and post-monsoon seasons)")
print("="*70)
...
}).to_csv(os.path.join(output_dir,'monsoon_predictions.csv'),
          index=False)
print("[OK] monsoon_predictions.csv")

importance_df.to_csv(
    os.path.join(output_dir,'feature_importance.csv'), index=False)
print("[OK] feature_importance.csv")

with open(os.path.join(output_dir,'monsoon_model_summary.txt'),
          'w', encoding='utf-8') as f:
    f.write("MONSOON SEASON - PM2.5 PREDICTION MODEL SUMMARY\n")
    f.write("="*70 + "\n\n")
    ...
    f.write("  - Fixed season-boundary split\n")
    ...
    f.write("  Train = 2018-2022, Test = 2023\n")
    f.write("  2023 used as test year as it represents\n")
    f.write("  the most recent complete monsoon season.\n")
    f.write("  Train and test PM2.5 means are very similar\n")
    f.write("  (Train=15.65, Test=16.15, diff=0.50 ug/m3)\n")
    f.write("  confirming 2023 is statistically representative.\n")
    f.write("  Quick diagnostic: Train R2=0.814, Test R2=0.683\n")
    f.write("  Gap=0.131 - excellent generalisation.\n\n")
...
print("[OK] monsoon_model_summary.txt")
